# Release Notes - 03/04/2026

## Portada

- Proyecto: `Proyecto Big Data KDD - Logistica`
- Documento: `Release notes iteracion 03/04/2026`
- Version: `v1.3-entrega`
- Fecha: `03/04/2026`
...
Este documento consolida los cambios funcionales y operativos aplicados hasta la iteracion del 3 de abril de 2026.
...
- Actualizacion de referencias internas a release notes de la iteracion vigente (`docs/release-notes-2026-04-03.md`).
...
- Sustitucion de la captura de referencia por la imagen actualizada:
  - `docs/dashboard.png` (actualizada el 03/04/2026).
...
- Regeneracion de PDFs de entrega con fecha `2026-04-03`.
